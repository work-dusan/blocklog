...
export default function BlockChain() {
  ...
  return (
    <div className="flex h-full">
      <div className="w-1/2 border-r border-gray-800 p-6 overflow-y-auto space-y-4">
        <h2 className="text-lg font-medium">System Simulation</h2>
      ...
      <div className="w-1/2 p-6 overflow-y-auto">
        ...
        {chain.map((block) => (
          <BlockCard
            ...
            isHacker={isHacker}
            onTamper={(newDetails) =>
              tamperBlock(block.index, newDetails, currentUser)
            }
          />
        ))}
      </div>
